...
class _CoinManagePageState extends State<CoinManagePage> {
  ...
  Future<void> _fetchCoinBalance() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://yaanzsuika.pterodactyl.biz.id:3632/refreshCoins?key=${widget.sessionKey}'),
      );
  ...
  try {
    final response = await http.get(
      Uri.parse('http://yaanzsuika.pterodactyl.biz.id:3632/redeem?key=${widget.sessionKey}&code=$code'),
    ).timeout(
  ...
  Future<void> _giftCoin() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://yaanzsuika.pterodactyl.biz.id:3632/giftCoin'),
        headers: {
